      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <motion.button
              className="px-10 py-5 bg-white text-black hover:bg-amber-500 hover:text-white transition-all duration-300 text-lg group"
              style={{ fontFamily: 'Space Grotesk, sans-serif' }}
            ...
            <motion.button
              className="px-10 py-5 border-2 border-white hover:bg-white hover:text-black transition-all duration-300 text-lg"
              style={{ fontFamily: 'Space Grotesk, sans-serif' }}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
